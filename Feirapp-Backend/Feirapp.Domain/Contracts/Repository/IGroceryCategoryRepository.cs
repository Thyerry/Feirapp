...
public interface IGroceryCategoryRepository
{
    ...
    Task<List<GroceryCategory>> InsertBatchAsync(List<GroceryCategory> groceryCategories,
    ...
    Task<List<GroceryCategory>> SearchAsync(GroceryCategory groceryCategory,
        CancellationToken cancellationToken = default);
}