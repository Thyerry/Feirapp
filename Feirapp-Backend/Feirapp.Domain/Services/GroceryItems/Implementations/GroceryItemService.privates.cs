...
{
    internal async Task<Store> ValidateAndRegisterStoreAltNameAsync(Store storeToCheck, CancellationToken ct)
    {
    ...
    internal async Task InsertNcmsAndCestsAsync(InsertGroceryItemsRequest request, CancellationToken ct)
    {
    ...
    internal static string ValidateBarcode(string barcode)
    {
